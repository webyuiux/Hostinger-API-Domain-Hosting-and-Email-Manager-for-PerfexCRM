                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="assigned_staff_id" id="assigned_staff_id" class="selectpicker form-control" data-width="100%" data-live-search="true">
                                    ...
                                    <option value="<?= $member['staffid']; ?>" <?= ($domain->assigned_staff_id == $member['staffid']) ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="client_email" id="client_email" class="form-control" value="<?= e($domain->client_email) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php
                                $CI = &get_instance();
                                $actual_mailbox_count = $CI->db->where('domain', $domain->domain_name)->where('deleted', 0)->count_all_results(db_prefix() . 'emails_manager');
                                ?>
                                <input type="number" name="available_mailbox_count" id="available_mailbox_count" class="form-control" value="<?= $actual_mailbox_count ?>" readonly>
                                <small class="text-muted">Calculated automatically from the Email Accounts module.</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <?php echo render_date_input('start_date', 'Start Date',
                                ($domain->start_date && $domain->start_date != '0000-00-00') ? _d($domain->start_date) : '',
